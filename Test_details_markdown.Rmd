...
text(sentrep.dat$age_at_test,sentrep.dat$nepsy_sent_rep_raw,label=sentrep.dat$sent_rep_ss)
lines(myage[1:16],myscore7[1:16],col="red")
lines(myage[1:16],myscore4[1:16],col="green")
lines(myage[1:16],myscore13[1:16],col="red")
lines(myage[1:16],myscore16[1:16],col="green")
...
On this subtest we again have data on the sample of 44 adults.
The norms for Oromotor sequences are provided differently in the test manual - perhaps because of non-normal data. They are also in whole year bands, rather than 6-monthly.
Rather than a scaled score, the manual has tables for raw scores to be converted into one of 5 percentile bands:
* above 75%
* 26-75%
* 11-25%
* 3-10%
...
The statistical approach is then similar to Nonword Repetition, except that rather than transforming scores on the basis of SD units, we take into account that the 25th and 75th centiles correspond to z-scores of  +/- .675.
...
text(oromotor.dat$age_at_test,oromotor.dat$nepsy_oromotor_seq_raw,
     label=oromotor.dat$oromotor_ss)
