...
my.t.dawba <- t.test(temp$Vocab~temp$withdawba) #Changed this AFTER final version was knitted
w1<-which(temp$withdawba==0)
sd.dawba0 <-sd(temp$Vocab[w1],na.rm=TRUE)
sd.dawba1<-sd(temp$Vocab[-w1],na.rm=TRUE)
