...
![<b>Figure 2</b>. SRS total T-scores for children in Low and High Bias subgroups by Trisomy. DAWBA diagnoses: Social anxiety = blue, ASD = red, both = purple; pink denotes ASD by parental report only ](/Users/dorothybishop/Dropbox/ERCadvanced/project SCT analysis/SCT_ASD_analysis/Project_files/Plots/beeswarm_srsT.pdf)

Only three children (both from Low Bias group, two with XXX and one with XXY) had social anxiety without an ASD diagnosis. A further seven boys had a joint diagnosis of social anxiety and ASD: five were XXY cases, and four of these came from the High Bias group. Rates of ASD diagnosis on DAWBA in children with an extra X chromosome were higher than general population prevalence, but nevertheless only a minority of children were affected. In cases of XYY, however, ASD was substantially higher, affecting `r p1.XYY.asd.d`% of the Low Bias group affected, and `r p2.XYY.asd.d`% of the High Bias group. When parental report of ASD diagnosis was included as well as DAWBA diagnosis, these rates rose to `r p1.XYY.asd`% of the Low Bias group affected, and `r p2.XYY.asd`% of the High Bias group.next question considered was whether the profile of scores on the SRS subscales differed across trisomies. Mean and SD for each SRS subscale are shown in table x.
```{r, echo=FALSE} 
