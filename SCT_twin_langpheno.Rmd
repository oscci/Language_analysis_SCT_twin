...
sct.redcap <- 'SCTDATA_DATA_2018-09-14_1345.csv'
#updated to include code indicating whether participated in prior study
twin.redcap <- 'TwinsData_DATA_2018-09-14_1344.csv' #updated to include ccc2_consistent variable
...
Table 2 shows the characteristics of the trisomy and twin groups on age and covariates. 
...
The same dataset was used to explore the relationship with family history of language problems, by running linear regressions for each of the four composite measures, with the family history score as a predictor. In no case did the association prove statistically robust (all p-values > .05). 
