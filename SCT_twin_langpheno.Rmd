...
twin.redcap <- 'TwinsData_DATA_2018-08-03_1414.csv' #updated to include ccc2_consistent variable
...
```{r colselect}
keepcols <- c('record_id','female','age_at_test','partial_testing','wasi_matrices_ss','wasi_block_design_ss','wasi_vocab_ss','wdck_jhsn_ss',
...
w<-which(all.short$splang_conc>0)
...
```{r wasi}
mycollist<-c('red','green','blue','pink','purple','darkblue','black','grey')
