...
library(flextable)
library(officer)
testbattery<-read.csv('testbattery.csv')
...
![Figure 1. Numbers of children included in different analyses.](SCT_flow.png)
...
```{r table1, echo=FALSE}
#usual problems with getting tables to print in Word. Seems I need pandoc 2.0
#https://davidgohel.github.io/flextable/articles/overview.html
#autofit(regulartable(testbattery))
regulartable(testbattery)
```
...
Characteristics of the samples on the covariates. (to be added)
