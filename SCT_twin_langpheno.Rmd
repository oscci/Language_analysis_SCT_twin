...
cccbit<-all.short[,c(1,(w-2):(w+10),x,y,z,z1,2,3)]#2 before ccc_a is GCC and SIDC
...
summary(aov.gcc)
beeswarm(temp1$gcc~temp1$trisomy*temp1$bias)
...
round(table(all.short$dldcat,all.short$sltcode),2)
