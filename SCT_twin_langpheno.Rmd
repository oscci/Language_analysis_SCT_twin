...
all.short$ccc2_data<-car::recode(all.short$ccc2_consistent,"1=1;0=0;NA=0")
 ...
 xyy_b3<-mytab3[3,2,1]
  ...
  flow1<-DiagrammeR::grViz("
              ...
              Q[label='* full sample, ** 6-11.11 age sample, *** CCC-2 sample']
...
We recruited `r scttab[1,1]+scttab[1,2]` girls with XXX, `r scttab[2,1]+scttab[2,2]` boys with XXY and `r scttab[3,1]+scttab[3,2]` boys with XYY to the study, in the age range from 5 years 0 months to 15 years 11 months. `r round(100*sum(origstudy)/sum(scttab),0)`% of the children had participated in the Bishop et al (2011) study. Recruitment was via NHS Clinical Genetics centres, two support groups (Unique: the Rare Chromosome Support Group, and the Klinefelter Syndrome Association) and self-referral through social media. To be included in the study, the child had to be aware of their trisomy status. During the initial telephone interviews, caregivers were asked how their child was diagnosed, in particular whether this followed postnatal testing motivated by neurodevelopmental/behavioural problems. The phenotype of such children may be more severe, potentially biasing the sample, and so we grouped them prospectively as a high-risk-of-bias (‘High Bias’) subgroup, comprised of 13 XXX, 26 XXY and 32 XYY cases. All other children formed the low-risk-of-bias (‘Low Bias’) subgroup, with 32 XXX, 20 XXY and 19 XYY cases. Our original lower age limit for the study was 6 years 0 months, but we included eleven 5-year-olds (3 low bias XXX, 2 low bias XYY, 2 high bias XXX and 4 high bias XYY) whose families volunteered for the study. Note, however, these children are excluded from our main analysis of language test data, because test norms did not extend this young for most of the measures. In addition, four cases had missing data that precluded inclusion in MANOVA. These cases are, however, included in the analysis of CCC-2 data. Thus, the Low Bias subgroups with psychometric test data consisted of 26 XXX, 20 XXY and 16 XYY cases.
